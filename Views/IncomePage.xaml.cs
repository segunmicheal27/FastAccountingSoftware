...
namespace FastAccountingSoftware.Views
{
    public partial class IncomePage : Page
    {
        ...
        {
            var dialog = new AddTransactionWindow(TransactionType.Income)
            {
        ...
        private void ExportExcel_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    CustomMessageBox.Show("Income transactions exported successfully as Excel CSV!", "Export Success", MessageBoxButton.OK, MessageBoxImage.Information);
                }
                catch (Exception ex)
                {
        ...
        private void ExportWord_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    html.Append("<h2>Income Transactions</h2>");
                    ...
                    CustomMessageBox.Show("Income transactions exported successfully as Word Document!", "Export Success", MessageBoxButton.OK, MessageBoxImage.Information);
                }
                catch (Exception ex)
                {
                    CustomMessageBox.Show($"Failed to export data: {ex.Message}", "Export Error", MessageBoxButton.OK, MessageBoxImage.Error);
        ...
        private void ExportPdf_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                var title = new System.Windows.Documents.Paragraph(new System.Windows.Documents.Run("Income Transactions"));
                title.FontSize = 24;
                ...
                if (printDialog.ShowDialog() == true)
                {
                    ...
                    printDialog.PrintDocument(idp.DocumentPaginator, "Income Transactions");
